      ...
      <div className="text-[#7D515E] flex flex-col min-h-screen">
        ...
        <div className="bg-[#F3EBF1] sm:text-xl text-md flex flex-1 justify-center items-center">
          <div className="flex flex-col gap-6 md:w-auto w-full md:p-0 p-4 ">
            ...
            <button onClick={() => prop.onNext(inputCreditCardNum)} className={`${buttonShadowEffect} w-full font-semibold shadow-[4px_4px_0px_0px_#B58396] hover:shadow-[2px_2px_0px_0px_#B58396] bg-[#C2ADB3] p-2 rounded-md`}>REVIEW ORDER SUMMARY</button>
